...
/*needs to add a book object into the datastructure in the library class.
    void addBook(string a, string t, string g, int isbn) {
        Book book = new Book(a, t, g, isbn);
...
public:
    ...
    //searchbook funtction
    //checkoutbook function
    //returnbook function
    //print student details function
    //print checkoutbooks list
    ...
    void inorder(Node* node) {
        if (node != nullptr) {
            ...
            cout << "Student ID: " << node->student.getId() 
                 << ", Name: " << node->student.getName() << endl;
            inorder(node->right);
        }
    }
...
{   
    ...
    cout <<"Enter '8' exit this program\n";
    cin >> x;
    switch(x) 
    {
        case 1:
